...
> Last updated: FR-HD-01/02 Home dashboard (SCR-06) opened as the next feature PR (roadmap "PR #62" slot; lands as the next available GitHub number ≥ #62 — the "#61" slot was consumed by the CI-pipeline PR `d474507`). FR-PR-05 (#60) and the CI speed-up (#61) are now **Merged**; the velocity Total is reconciled to **96 SP / 23 PRs** through FR-PR-05.
...
> feature PR, FR-HD-01/02 Home dashboard (5 SP, roadmap slot ≥ #62), is
> Open and will be added on merge.
