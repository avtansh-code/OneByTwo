...
> Last updated: FR-AU-09 permanently delete your account (#65, `d542793`) is now **Merged**; the velocity Total is reconciled to **117 SP / 27 PRs** through FR-AU-09 — **every P0 functional requirement is shipped and FR-AU-09 was the second top-ranked remaining P1** (FR-PR-02 #64 was the first). FR-HD-03 (current-month spend summary with a category breakdown chart, SRS section 4.8 line 248, **P1**) opened as the next feature PR — the **top-ranked remaining P1** on the carry-forward candidate list and the **last open Home-dashboard requirement** (FR-HD-01/02 shipped in #62, FR-HD-04 in #57); it lands as the next available GitHub number (≥ #67 now that FUTURE issue #66 is filed; reconcile the slot label at PR open).
...
| #67 | 5 | Open (FR-HD-03 monthly spend category breakdown chart) |
| **Total** | **117** | **27 PRs so far** |
...
> CI pipeline speed-up) are merged but carry no feature SP. FR-AU-09
> permanently delete your account (8 SP) merged as #65
> (`d542793`) and is now counted in the Total. The next feature PR,
> FR-HD-03 monthly spend category breakdown chart (5 SP, the top-ranked
> remaining P1; opened as the FR-HD-03 PR, expected #67), is Open and its
> 5 SP will be added to the Total on merge.
