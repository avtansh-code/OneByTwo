...
| #75 | 0 | Open — `docs` close-out bundle (closes #19 / #24 / #28); pure docs/design, **velocity-excluded** (like #59 / #61 / #73), so it contributes 0 and is not in the "PRs so far" tally |
| **Total** | **137** | **33 PRs so far** |
...
> / 33 PRs**. The next PR — the **`docs` close-out bundle** (#75, closes #19 / #24 /
> #28) — is pure docs/design and **velocity-excluded** (same rule as #59 / #61 / #73),
> so it contributes **0** and the Total stays at **137 / 33**. With every P0 except the
> Sprint-3 Groups epic and every P1 shipped, the velocity Total stands at **137 SP / 33
> PRs**. The Total is never silently inflated.
