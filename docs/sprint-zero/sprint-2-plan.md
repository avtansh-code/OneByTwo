...
| #76 | 5 | Open — `test` close-out bundle (closes #20; re-scopes #23, with RT2 + INV2 closed with evidence and the PY3 Flutter-harness remainder kept open); substantive test engineering, **5 SP** counted in the Total when the next reconciliation flips it to Merged (137 / 33 → 142 / 34) |
