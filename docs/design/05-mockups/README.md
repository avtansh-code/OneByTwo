...
This directory contains nine self-contained HTML mockups for the hero screens
...
Hi-fi mockups are produced for these nine hero screens. Every other screen
...
| 9 | `09-friends.html` | Friends list, Add Friend, Friend Detail, Delete Friend dialog | FR-FR-01 through FR-FR-05 | `04-wireframes/friends-flow.md` |
