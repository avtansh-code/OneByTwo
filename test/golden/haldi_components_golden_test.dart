...
//
// This group is ENABLED, consistent with DC-01 / DC-02: the pixel
...
// (04-qa-test-strategy.md sections A.2.2 and E). Animated surfaces
// (shimmer, sync spin, segment selection) are captured at a pinned,
// reduced-motion frame (section A.2.5 / C.3).
...
void main() {
  group('Haldi shared components (DC-03)', () {
