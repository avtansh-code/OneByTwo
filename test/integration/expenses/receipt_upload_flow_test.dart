...
void main() {
  group(
    'Receipt upload integration (FR-EX-05) — round-trip via Firebase '
    'Storage + the onExpenseWriteFriendship trigger',
    () {
      test(
        'end-to-end: user A creates a friendship expense with a JPEG '
      ...
      test(
        'end-to-end: user A edits an existing expense to REPLACE its '
      ...
      test(
        'end-to-end: user A edits an existing expense to REMOVE its '
