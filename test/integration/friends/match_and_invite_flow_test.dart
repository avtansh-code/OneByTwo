...
void main() {
  group('MatchAndInviteFlow integration', () {
    test(
      'end-to-end: pick seeded contact, lookup matches, confirm, '
      'friendship created',
      () {
    ...
    test(
      'end-to-end: pick unseeded contact, lookup returns no match, '
    ...
    test(
      'duplicate: pre-created friendship results in '
